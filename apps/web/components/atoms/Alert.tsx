...
export const Alert: React.FC<AlertProps> = ({
  ...
  const className = cn(
    ...
    {
      "bg-green-500/10 border border-green-700 text-green-100":
        type === "success",
      "bg-red-500/10 border border-red-700 text-red-100": type === "error",
      "bg-blue-500/10 border border-blue-700 text-blue-100": type === "info",
    },
    "flex flex-row gap-2",
    classNameProp,
  );
