  ...
  return (
    <>
      <div className="relative -mb-16 hidden h-[420px] overflow-hidden md:block">
        {blogPost.mainImage ? (
          <div className="absolute -top-4 -right-4 -bottom-4 -left-4 opacity-30">
            <SanityImage
        ...
        <div className="absolute top-0 right-0 bottom-0 left-0 mx-auto grid max-w-[900px] items-center gap-6 p-4 md:grid-cols-[3fr_2fr] lg:grid-cols-[2fr_1fr] xl:max-w-[1000px]">
